...
It looks like you're interested in contributing to markdown-it-variables, thank you so much! Whether
...
free to create a
[new discussion](https://github.com/Dschungelabenteuer/markdown-it-variables/discussions).
...
```bash
# Using HTTPS
git clone https://github.com/your-username/markdown-it-variables.git

# Using SSH
git clone git@github.com:your-username/markdown-it-variables.git
```
